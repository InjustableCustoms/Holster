...
Citizen.CreateThread(function()
	while true do
      ...
      loadAnimDict("reaction@intimidation@cop@unarmed")
        ...
        if holstered then
          TriggerEvent("holster:sounds", "unholster", 0.9)
					TaskPlayAnim(ped, "rcmjosh4", "josh_leadout_cop2", 7.0, 2.0, -1, 48, 10, 0, 0, 0 )
					Citizen.Wait(600)
					ClearPedTasks(ped)
					holstered = false
				end
        ...
        if not holstered then
          TriggerEvent("holster:sounds", "holster", 0.9)
					TaskPlayAnim(ped, "rcmjosh4", "josh_leadout_cop2", 7.0, 2.0, -1, 48, 10, 0, 0, 0 )
					Citizen.Wait(500)
					ClearPedTasks(ped)
					holstered = true
